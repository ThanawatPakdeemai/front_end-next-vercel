...
import useDrawerControllerMobile from "../../containers/hooks/useDrawerControllerMobile"
import GameInfoCard from "../molecules/GameInfoCard"

export interface IGameSectionProps {
  gameData: IGame
}

const GameSectionMobile = ({ gameData }: IGameSectionProps) => {
...
export default GameSectionMobile
