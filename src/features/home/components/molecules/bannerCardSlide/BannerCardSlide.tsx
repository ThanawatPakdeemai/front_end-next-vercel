...
const BannerCardSlide = ({ slide, slideNext }: IBannerCardSlide) => (
  <div className="slide-item flex gap-4 bg-grey-A200 align-middle text-white-default">
    ...
    <div className="w-3/5 justify-between md:flex md:flex-col md:gap-4 lg:w-1/4">
      <div className="slide-item--content flex flex-col justify-between rounded-3xl bg-grey-A100 p-8 md:h-full">
        ...
        <footer className="slide-item--footer flex items-center justify-between">
          ...
          <div className="slide-item--favorite">
            <button
              type="button"
              className="flex h-16 w-16 items-center justify-center rounded-full bg-grey-A200"
            >
